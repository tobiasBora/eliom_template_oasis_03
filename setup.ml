...
(* OASIS_START *)
(* DO NOT EDIT (digest: ffce2fee76ba69e0872b59848370cef5) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["server/An_eliom_file"; "Amodule"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\213\128\136\220\246T\tn\164-\180\224\244u\2131";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
