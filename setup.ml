...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9d4d0cc72a386bcf41f95a8a0aa5e2f3) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["An_eliom_file"; "Amodule"];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = [];
                      bs_data_files =
                        [("../../_build/src/client/monproj.js", None)];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["An_eliom_file"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "monproj";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "monproj-client";
                           FindlibPackage ("eliom.client", None);
                           FindlibPackage ("lwt", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                   ...
                   {exec_custom = false; exec_main_is = "monproj.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "a\t÷²\024±\\çú½SäõÒ<X";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
